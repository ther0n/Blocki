...
remote func pre_start_game(spawn_points):
	# Change scene
	var world = load("res://scenes/test.tscn").instance()
...
func join_game(address, new_player_name):
	player_name = new_player_name
	var host = WebSocketClient.new()
	host.connect_to_url("ws://" + address + ":" + str(DEF_PORT), PoolStringArray([PROTO_NAME]), true)
